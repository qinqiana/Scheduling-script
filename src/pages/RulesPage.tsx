        ...
        <div>
          <div className="card">
            ...
            <ul className="conflict-list">
              ...
              <li>月末最后三天（法定假日除外，本月不满一周也算）要多排人：每组最多休 1 人，且至少 2 个晚班在岗。</li>
              ...
              <li>两天休息尽量连在一起（软约束，跨周也算，如周日接周一；覆盖和周 5 天优先）。</li>
              <li>除月末最后三天外，每组每天早晚班尽量接近 2:1（软约束）。月末三天仍按硬约束多排晚班。</li>
              <li>除月末三天外，同一个人的早班和晚班最多切一次（一段早 + 一段晚，顺序不限）。法定假加班不计入切换。生成穿插是硬冲突；不改锁定格就压不下去的不罚。2:1 和连休让给这条。</li>
